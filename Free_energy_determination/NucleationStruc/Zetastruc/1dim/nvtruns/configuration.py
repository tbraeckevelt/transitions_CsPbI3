...
pathdata = '/pfs/lustrep2/scratch/project_465001125/tbraecke/CsPbI3_intermediates/OwnMLP/NucleationStruc/Zetastruc/1dim/nvtruns/data/'
names = ['int_1', 'int_2a', 'int_2b', 'int_layer_1']
phases = {}
for name in names:
