...
pathdata = '/pfs/lustrep2/scratch/project_465001125/tbraecke/CsPbI3_intermediates/OwnMLP/NucleationStruc/FAdeltastruc/nvtruns/data/'
names = ['int_1a', 'int_1b', 'int_1c', 'int_1a_double', 'int_2a_double', 'int_3a_double', 'int_4a_double', 'int_4b_double', 'int_4c_double']
phases = {}
for name in names:
