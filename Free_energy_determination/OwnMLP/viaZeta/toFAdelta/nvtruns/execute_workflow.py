...
WORKFLOW_KEYS = (KEY_INITIALIZATION, KEY_SAMPLING, KEY_NVT, KEY_OPT, KEY_HESS, KEY_TI_LOW, KEY_INTERMEDIATE, KEY_TI_HIGH)#, KEY_TI_LOT, KEY_NVT_LOT, KEY_OPT_LOT, KEY_HESS_LOT)
