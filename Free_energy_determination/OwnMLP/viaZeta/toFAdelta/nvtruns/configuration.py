...
pathdata = '/pfs/lustrep2/scratch/project_465001125/tbraecke/CsPbI3_intermediates/OwnMLP/viaZeta/toFAdelta/nvtruns/data/'
names = ['int_1', 'int_2', 'int_3', 'int_layer', 'FAdelta']
phases = {}
for name in names:
