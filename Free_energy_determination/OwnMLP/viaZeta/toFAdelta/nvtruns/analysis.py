...
from execute_workflow import DIR_PREFIX, FILE_TASK_YAML, KEY_NVT, KEY_OPT, KEY_HESS, KEY_TI_LOW, KEY_INTERMEDIATE, KEY_TI_HIGH, KEY_TI_LOT, KEY_NVT_LOT, KEY_OPT_LOT, KEY_HESS_LOT
...
from configuration import phases, config, TEMPERATURE_GRID, HARM_T, T_MAX
...
for phase in phases:
    ...
    try:
        ...
        free_energy = {'harm': [], 'intermediate': [], 'nvt': []}
        free_error = {'harm': [], 'intermediate': [], 'nvt': []}
        ...
        for pes in ['harm', 'intermediate', 'nvt']:
