...
pathdata = '/pfs/lustrep2/scratch/project_465001125/tbraecke/CsPbI3_intermediates/OwnMLP/viaZeta/toCsdelta/nvtruns/data/'
names = ['zeta', 'zeta_shift', 'int_1', 'int_2a', 'int_2b', 'int_3', 'int_3and4', 'int_4a', 'int_4b', 'Csdelta']
phases = {}
for name in names:
