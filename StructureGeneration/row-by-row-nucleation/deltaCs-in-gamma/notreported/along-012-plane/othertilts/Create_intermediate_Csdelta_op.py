...
cspbi3.atoms.cell[1,:] -= np.floor(2*height/depth)*cspbi3.atoms.cell[2,:]  # check if prefered, depends on height and depth
...
write('int_2b_double_connected.xyz', cspbi3.atoms, format="extxyz")
