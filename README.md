...
- **MLPtraining**: This folder contains the files used to extract MD sampled structures from the TI workflow discussed in the `Free_energy_determination` folder, to subsequently recalculate them with VASP, and finally to train a MACE MLIP on the resulting VASP data set.
